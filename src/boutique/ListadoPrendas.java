...
public class ListadoPrendas extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ListadoPrendasGeneral lpg = new ListadoPrendasGeneral(null, true);
        lpg .getContentPane().setBackground(new Color(255,255,204));
        lpg.setLocationRelativeTo(null);
        lpg.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        SeleccionarColor sc = new SeleccionarColor(null, true);
        sc.getContentPane().setBackground(new Color(255,255,204));
