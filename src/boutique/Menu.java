...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setText("Alta Prenda");
        ...
        jButton1.setText("Listado Prendas");
        ...
        jButton3.setText("Modificar Prenda");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/boutique/muyIgualLogo.png"))); // NOI18N
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        ap.getContentPane().setBackground(new Color(255,255,204));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        lp.getContentPane().setBackground(new Color(255,255,204));
    ...
    ModificarPrenda mp = new ModificarPrenda(this,true);
    mp.getContentPane().setBackground(new Color(255,255,204));
    mp.setLocationRelativeTo(null);
    mp.setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
    Totales t = new Totales(this,true);
    t.getContentPane().setBackground(new Color(255,255,204));
